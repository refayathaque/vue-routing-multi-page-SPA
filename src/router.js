...
const router = createRouter({
  ...
  routes: [
    { path: "/", redirect: "/teams" },
    {
      ...
      path: "/teams",
      meta: { needsAuth: true },
      // can be used to pass in extra information that can be accessed by local or global navigation guards within `to` or `from` arguments (look at `router.beforeEach` below)
...
router.afterEach(function (to, from) {
  console.log("Global afterEach navigation guard");
  console.log(to, from);
